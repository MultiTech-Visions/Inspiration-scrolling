...
const DEFAULT_INSTRUCTIONS = {
  ...
  synthesize_discovery:
    [
      ...
      '',
      'You have the web_search tool available. Use it to find 3-6 recent, high-quality real sources about the theme before writing the card. Prefer primary sources (blog posts, papers, project repos, official docs, conference talks) over aggregators.',
      '',
      'Your output is JSON, conforming to:',
      '  {',
      ...
      '    "source_urls": string[],      // every URL must be a URL you actually retrieved via web_search',
      '    "video": null | {"embeddable": bool, "source_url": string, "provider": "youtube"|"twitter"|"instagram"|"reddit"|"other"},',
      '    "discussion_context": string  // HIDDEN field. ~3-6 paragraphs of additional context the model should have on hand if the user opens a discussion thread about this card: more detail on what the sources said, adjacent ideas you considered but didn\'t put in the body, prerequisites, gotchas, alternative angles. The user does NOT see this in the feed.',
      '  }',
      '',
      'Rules:',
      ...
      '- The card may combine what you read with your own framing/ideas. Be honest about what came from the sources vs. what is suggested next steps.',
